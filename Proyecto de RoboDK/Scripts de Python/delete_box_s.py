"""
Este script borra el contenido del AGV - Caja S tras haber sido llenada. Con
...
Después de borrar el contenido del AGV - Caja S, este vuelve
...
try:
    box_to_be_deleted = RDK.Item('Caja S - aux', ITEM_TYPE_OBJECT)
