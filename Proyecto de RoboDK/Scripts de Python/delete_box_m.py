"""
Este script borra el contenido del AGV - Caja M tras haber sido llenada. Con
...
Después de borrar el contenido del AGV - Caja M, este vuelve
...
try:
    box_to_be_deleted = RDK.Item('Caja M - aux', ITEM_TYPE_OBJECT)
